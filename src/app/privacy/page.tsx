      ...
      <main className="flex-1 container max-w-4xl mx-auto px-6 py-16 md:py-24 -mt-10 md:-mt-16 relative z-20">
        <div className="bg-white rounded-3xl p-8 sm:p-12 md:p-16 shadow-xl border border-zinc-200/60">
          <div className="space-y-12 text-zinc-600 text-lg leading-relaxed font-medium">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">4. Data Sharing and Disclosure</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">5. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">6. Your Data Rights</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-black text-zinc-900 mb-6">7. Changes to This Policy</h2>
              <p>
