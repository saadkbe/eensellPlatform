...
export default function AdminLiveCallsPage() {
  ...
  return (
    <div className="space-y-8 pb-8">
      {/* ── Premium Header ── */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-500/10 via-indigo-500/5 to-background border border-border p-8 sm:p-10 shadow-sm">
        ...
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-indigo-500/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <div className="shrink-0">
            <Dialog open={scheduleOpen} onOpenChange={setScheduleOpen}>
              <DialogTrigger className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 transition-all">
                ...
                <div className="space-y-4 py-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="flex h-10 w-full rounded-lg border border-border bg-muted/30 px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring mt-1"
                    />
                  </div>
                  <div>
                    <Label className="text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <Card className="bg-card/40 backdrop-blur-xl border-border hover:border-blue-500/20 transition-all duration-300 group">
        ...
        <Card className="bg-card/40 backdrop-blur-xl border-border hover:border-indigo-500/20 transition-all duration-300 group">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
        ...
        <Card className="bg-card/40 backdrop-blur-xl border-border hover:border-emerald-500/20 transition-all duration-300 group">
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
            ...
            <div className="divide-y divide-border/50">
              {upcomingCalls.map((call) => {
                ...
                return (
                  <div
                    key={call.id}
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-5 hover:bg-muted/30 transition-colors group gap-4"
                  >
                  ...
                  <div className="flex items-center gap-2 shrink-0 sm:ml-4">
                    ...
                    {call.replayUrl ? (
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="gap-1.5 text-xs border-border hover:border-indigo-500/30 hover:bg-indigo-500/5"
                        onClick={() => {
          ...
          <div className="space-y-4 py-2">
            <Tabs value={replayMode} onValueChange={setReplayMode} className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-4 bg-muted/50 p-1 rounded-lg">
                <TabsTrigger value="link" className="data-[state=active]:bg-card data-[state=active]:shadow-sm rounded-md text-xs">
                  Paste URL
                </TabsTrigger>
                <TabsTrigger value="upload" className="data-[state=active]:bg-card data-[state=active]:shadow-sm rounded-md text-xs">
                  Upload Video
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="upload" className="mt-0">
                <div className="space-y-3">
                  <Label className="text-xs text-muted-foreground">Upload MP4/WebM *</Label>
                  {replayUrl && replayMode === "upload" ? (
                    <div className="flex items-center gap-3 rounded-lg border border-indigo-500/30 bg-indigo-500/5 p-3 mt-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-foreground truncate">Video uploaded successfully</p>
                        <p className="text-xs text-muted-foreground truncate">{replayUrl}</p>
                      </div>
                      <Button
                        variant="ghost"
                        size="sm"
