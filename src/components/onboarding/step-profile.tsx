  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center py-12 px-4 sm:px-6 bg-background onboarding-bg text-foreground overflow-x-hidden">
      <motion.div 
        ...
        initial="hidden"
        animate="show"
        className="max-w-3xl w-full flex flex-col gap-12 pb-8"
      >
        {/* Header */}
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center gap-4">
          <div className="relative group">
            <div className={cn(
              ...
              isUploading ? "border-orange-500 opacity-50" : "border-zinc-800 group-hover:border-zinc-600"
            )}>
              {imageUrl ? (
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <div className="relative max-w-sm">
            <Input
              ...
              className="bg-zinc-900/50 border-zinc-800 text-white placeholder:text-zinc-600 focus-visible:ring-orange-500 h-12 pl-4"
            />
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          <h2 className="text-lg font-semibold text-white">
            What is your primary goal? <span className="text-orange-400 text-sm font-normal">*</span>
          </h2>
