...
export function TopBar() {
  ...
  return (
    <div className="sticky top-16 lg:top-0 z-30 w-full flex items-center justify-between px-4 sm:px-8 lg:px-10 py-3 sm:py-5 bg-card/95 backdrop-blur-md border-b border-border transition-all duration-300 shadow-sm">
