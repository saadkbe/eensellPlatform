          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-6 font-bold text-sm text-zinc-500">
                ...
                <div>
                  <p className={`font-semibold text-sm truncate max-w-[120px] sm:max-w-[140px] ${isTop3 ? "text-white" : "text-zinc-200"}`}>
                    {user.firstName} {user.lastName}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-black/40 rounded-lg border border-white/5 shadow-inner">
                <Star className={`w-3.5 h-3.5 ${isTop3 ? "text-amber-400 fill-amber-400 drop-shadow-[0_0_5px_rgba(251,191,36,0.6)]" : "text-zinc-500"}`} />
                <span className={`font-mono text-sm font-bold ${isTop3 ? "text-amber-400" : "text-zinc-300"}`}>
                  {user.xp}
                </span>
              </div>
            </motion.div>
