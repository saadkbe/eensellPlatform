            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-foreground font-bold">حجم سوق الذكاء الاصطناعي</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                <div className="w-16 h-16 rounded-full bg-success/10 flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.3)]">
                  <div className="w-8 h-8 rounded-full bg-success animate-pulse-slow" style={{ animationDelay: '1s' }} />
                </div>
                <div>
                  <h3 className="text-5xl font-black text-success mb-1">10x</h3>
                  <p className="text-lg text-foreground font-bold">أسرع في الإنتاجية</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6">
                <div className="w-16 h-16 rounded-full bg-warning/10 flex items-center justify-center shadow-[0_0_30px_rgba(245,158,11,0.3)]">
                  <div className="w-8 h-8 rounded-full bg-warning animate-pulse-slow" style={{ animationDelay: '2s' }} />
                </div>
                <div>
        ...
        >
          <div className="animated-border rounded-[2.5rem]">
            <div className="glass-card rounded-[2.5rem] p-12 text-center relative overflow-hidden group bg-background/80 dark:bg-black/80">
              ...
              <Sparkles className="absolute bottom-12 left-16 w-8 h-8 text-success opacity-50 animate-pulse" style={{ animationDelay: '1s' }} />
              <Sparkles className="absolute top-1/2 left-1/4 w-4 h-4 text-warning opacity-50 animate-pulse" style={{ animationDelay: '2s' }} />
